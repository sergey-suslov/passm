...
impl Widget for HelpTab {
    fn render(self, area: tui::layout::Rect, buf: &mut tui::buffer::Buffer) {
        let message = match self.page {
            ActivePage::PasswordsList => "a: create new",
            ActivePage::CreateNewPasswordName => "Ctrl+c: cancel | Enter: continue",
            ActivePage::CreateNewPasswordBody => "Ctrl+c: cancel | Ctrl+d: save",
        };
